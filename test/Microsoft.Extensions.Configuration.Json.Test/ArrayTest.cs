...
namespace Microsoft.Extensions.Configuration.Json.Test
{
    public class ArrayTest
    {
        ...
        public void ArraysAreConvertedToKeyValuePairs()
        {
            ...
            var jsonConfigSource = new JsonConfigurationProvider(TestStreamHelpers.StringToStream(json));
        ...
        public void ImplicitArrayItemReplacement()
        {
            ...
            var jsonConfigSource1 = new JsonConfigurationProvider(TestStreamHelpers.StringToStream(json1));
            var jsonConfigSource2 = new JsonConfigurationProvider(TestStreamHelpers.StringToStream(json2));
