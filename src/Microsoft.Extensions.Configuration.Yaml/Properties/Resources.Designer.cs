...
namespace Microsoft.Extensions.Configuration.Yaml
{
    ...
    internal static class Resources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.Extensions.Configuration.Yaml.Resources", typeof(Resources).GetTypeInfo().Assembly);
        ...
        /// Could not parse the YAML file. Error on line number '{0}': '{1}'.
        /// </summary>
        internal static string FormatError_YAMLParseError(object p0, object p1)
        {
            return string.Format(CultureInfo.CurrentCulture, GetString("Error_YAMLParseError"), p0, p1);
        }
        ...
        /// <summary>
        /// Unsupported YAML token '{0}' was found. Path '{1}', line {2} position {3}.
        /// </summary>
        internal static string Error_UnsupportedYAMLToken
        {
            get { return GetString("Error_UnsupportedYAMLToken"); }
        }

        /// <summary>
        /// Unsupported YAML token '{0}' was found. Path '{1}', line {2} position {3}.
        /// </summary>
        internal static string FormatError_UnsupportedYAMLToken(object p0, object p1, object p2, object p3)
        {
            return string.Format(CultureInfo.CurrentCulture, GetString("Error_UnsupportedYAMLToken"), p0, p1, p2, p3);
        }
