...
namespace Microsoft.Extensions.Configuration
{
    public static class FileProviderExtensions
    {
        ...
        public static IConfigurationProvider ReloadOnChanged(this IConfigurationProvider config, string filename)
        {
            if (config == null)
            {
                throw new ArgumentNullException(nameof(config));
        ...
        public static IConfigurationProvider ReloadOnChanged(
