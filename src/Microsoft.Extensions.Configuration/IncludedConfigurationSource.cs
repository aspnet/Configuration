...
{
    public class IncludedConfigurationSource : IConfigurationSource
    {
        public IConfiguration Source { get; set; }

        public IConfigurationProvider Build(IConfigurationBuilder builder)
        {
            return new IncludedConfigurationProvider(Source);
        }

        private class IncludedConfigurationProvider : ConfigurationProvider
        {
